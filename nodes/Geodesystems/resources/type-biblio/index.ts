...
export const typeBiblioDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Biblio",
					"value": "Search Biblio",
					"action": "Search API for 'Bibliographic Entry' entry type",
					"description": "API to search for entries of type Bibliographic Entry",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/biblio"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/biblio",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Biblio Primary Author",
			"name": "search-biblio-primary_author",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.biblio.primary_author",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Biblio Type",
			"name": "search-biblio-type",
		...
		{
			"displayName": "Search Biblio Institution",
			"name": "search-biblio-institution",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.biblio.institution",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Biblio Other Authors",
			"name": "search-biblio-other_authors",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.biblio.other_authors",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Biblio Publication",
			"name": "search-biblio-publication",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.biblio.publication",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
