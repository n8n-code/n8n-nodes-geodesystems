...
export const typeBioHmmerIndexDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Hmmer Index"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Hmmer Index",
					"value": "Search Bio Hmmer Index",
					"action": "Search API for 'HMMER Index File' entry type",
					"description": "API to search for entries of type HMMER Index File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_hmmer_index"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_hmmer_index",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
