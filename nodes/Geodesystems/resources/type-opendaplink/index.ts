...
export const typeOpendaplinkDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Opendaplink",
					"value": "Search Opendaplink",
					"action": "Search API for 'OPeNDAP Link' entry type",
					"description": "API to search for entries of type OPeNDAP Link",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/opendaplink"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/opendaplink",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
