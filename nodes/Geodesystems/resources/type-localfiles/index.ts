...
export const typeLocalfilesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Localfiles",
					"value": "Search Localfiles",
					"action": "Search API for 'Server Side Files' entry type",
					"description": "API to search for entries of type Server Side Files",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/localfiles"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/localfiles",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
