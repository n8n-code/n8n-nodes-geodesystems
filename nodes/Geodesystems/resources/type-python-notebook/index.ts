...
export const typePythonNotebookDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Python Notebook",
					"value": "Search Python Notebook",
					"action": "Search API for 'IPython Notebook file' entry type",
					"description": "API to search for entries of type IPython Notebook file",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/python_notebook"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/python_notebook",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
