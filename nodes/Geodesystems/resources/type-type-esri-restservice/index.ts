...
export const typeTypeEsriRestserviceDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Restservice"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Restservice",
					"value": "Search Type Esri Restservice",
					"action": "Search API for 'ESRI Rest Service' entry type",
					"description": "API to search for entries of type ESRI Rest Service",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_restservice"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_restservice",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
