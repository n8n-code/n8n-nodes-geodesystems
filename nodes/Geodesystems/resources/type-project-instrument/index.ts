...
export const typeProjectInstrumentDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Instrument"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Instrument",
					"value": "Search Project Instrument",
					"action": "Search API for 'Instrument Data Collection' entry type",
					"description": "API to search for entries of type Instrument Data Collection",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_instrument"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_instrument",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
