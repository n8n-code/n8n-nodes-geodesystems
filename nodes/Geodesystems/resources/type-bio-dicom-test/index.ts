...
export const typeBioDicomTestDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Dicom Test",
					"value": "Search Bio Dicom Test",
					"action": "Search API for 'DICOM Test File' entry type",
					"description": "API to search for entries of type DICOM Test File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_dicom_test"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_dicom_test",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Bio Dicom Test Patient Name",
			"name": "search-bio_dicom_test-PatientName",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.bio_dicom_test.PatientName",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Bio Dicom Test Patient ID",
			"name": "search-bio_dicom_test-PatientID",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.bio_dicom_test.PatientID",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
