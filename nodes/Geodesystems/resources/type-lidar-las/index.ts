...
export const typeLidarLasDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Lidar Las",
					"value": "Search Lidar Las",
					"action": "Search API for 'LAS Lidar Data' entry type",
					"description": "API to search for entries of type LAS Lidar Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/lidar_las"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/lidar_las",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
