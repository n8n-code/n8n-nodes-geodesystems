...
export const typeTypeAwcMetarDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Awc Metar",
					"value": "Search Type Awc Metar",
					"action": "Search API for 'AWC Weather Observations' entry type",
					"description": "API to search for entries of type AWC Weather Observations",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_awc_metar"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_awc_metar",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Awc Metar Site ID",
			"name": "search-type_awc_metar-site_id",
			"description": "Site ID",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_awc_metar.site_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
