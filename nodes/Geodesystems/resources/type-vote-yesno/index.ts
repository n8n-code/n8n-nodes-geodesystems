...
export const typeVoteYesnoDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Vote Yesno",
					"value": "Search Vote Yesno",
					"action": "Search API for 'Simple Yes-No Vote' entry type",
					"description": "API to search for entries of type Simple Yes-No Vote",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/vote_yesno"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/vote_yesno",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Vote Yesno Vote",
			"name": "search-db_vote_yesno-vote",
			"description": "My Vote",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_vote_yesno.vote",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
