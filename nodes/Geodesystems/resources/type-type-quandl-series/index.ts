...
export const typeTypeQuandlSeriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Quandl Series"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Quandl Series",
					"value": "Search Type Quandl Series",
					"action": "Search API for 'QUANDL Series' entry type",
					"description": "API to search for entries of type QUANDL Series",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_quandl_series"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_quandl_series",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
