...
export const typeTypeDocumentPdfDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Document PDF",
					"value": "Search Type Document PDF",
					"action": "Search API for 'PDF File' entry type",
					"description": "API to search for entries of type PDF File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_pdf"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_pdf",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
