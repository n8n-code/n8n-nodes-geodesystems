...
export const typeTypePsdMonthlyClimateIndexDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Psd Monthly Climate Index"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Psd Monthly Climate Index",
					"value": "Search Type Psd Monthly Climate Index",
					"action": "Search API for 'NOAA-ESRL-PSD Monthly Climate Index' entry type",
					"description": "API to search for entries of type NOAA-ESRL-PSD Monthly Climate Index",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_psd_monthly_climate_index"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_psd_monthly_climate_index",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Psd Monthly Climate Index"
					]
				}
			}
		},
		...
		{
			"displayName": "Search Type Psd Monthly Climate Index Units",
			"name": "search-type_psd_monthly_climate_index-units",
			"description": "Units",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_psd_monthly_climate_index.units",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
