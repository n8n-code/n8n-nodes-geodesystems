...
export const typeFitsDataDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Fits Data",
					"value": "Search Fits Data",
					"action": "Search API for 'FITS Data File' entry type",
					"description": "API to search for entries of type FITS Data File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/fits_data"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/fits_data",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Fits Data Origin",
			"name": "search-fits_data-origin",
			"description": "Origin",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.fits_data.origin",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Fits Data Telescope",
			"name": "search-fits_data-telescope",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.fits_data.telescope",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Fits Data Instrument",
			"name": "search-fits_data-instrument",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.fits_data.instrument",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
