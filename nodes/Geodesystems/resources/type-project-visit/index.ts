...
export const typeProjectVisitDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Visit",
					"value": "Search Project Visit",
					"action": "Search API for 'Site Visit' entry type",
					"description": "API to search for entries of type Site Visit",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_visit"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_visit",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
