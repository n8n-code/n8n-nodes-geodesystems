...
export const typeTypeEiaSeriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Eia Series"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Eia Series",
					"value": "Search Type Eia Series",
					"action": "Search API for 'EIA Series' entry type",
					"description": "API to search for entries of type EIA Series",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_eia_series"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_eia_series",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
