...
export const typeSlackTeamDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Slack Team",
					"value": "Search Slack Team",
					"action": "Search API for 'Slack Team' entry type",
					"description": "API to search for entries of type Slack Team",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/slack_team"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/slack_team",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
