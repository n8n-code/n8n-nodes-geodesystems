...
export const typeTypeWmsLayerDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Wms Layer",
					"value": "Search Type Wms Layer",
					"action": "Search API for 'WMS Layer' entry type",
					"description": "API to search for entries of type WMS Layer",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_wms_layer"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_wms_layer",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
