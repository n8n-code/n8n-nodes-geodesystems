...
export const typeProjectCasestudyDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Casestudy",
					"value": "Search Project Casestudy",
					"action": "Search API for 'Case Study' entry type",
					"description": "API to search for entries of type Case Study",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_casestudy"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_casestudy",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Casestudy Intended Use",
			"name": "search-project_casestudy-intended_use",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_casestudy.intended_use",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Casestudy Location",
			"name": "search-project_casestudy-location",
			"description": "Where",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_casestudy.location",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
