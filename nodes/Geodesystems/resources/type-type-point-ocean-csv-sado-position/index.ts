...
export const typeTypePointOceanCsvSadoPositionDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean CSV Sado Position"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean CSV Sado Position",
					"value": "Search Type Point Ocean CSV Sado Position",
					"action": "Search API for 'SADO Position Data' entry type",
					"description": "API to search for entries of type SADO Position Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_csv_sado_position"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_csv_sado_position",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean CSV Sado Position"
					]
				}
			}
		},
