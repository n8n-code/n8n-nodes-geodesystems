...
export const typeTypePointOceanCnvDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean Cnv"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean Cnv",
					"value": "Search Type Point Ocean Cnv",
					"action": "Search API for 'SeaBird CNV Data' entry type",
					"description": "API to search for entries of type SeaBird CNV Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_cnv"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_cnv",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
