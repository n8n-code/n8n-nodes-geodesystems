...
export const typeLidarCollectionDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Lidar Collection"
					]
				}
			},
			"options": [
				{
					"name": "Search Lidar Collection",
					"value": "Search Lidar Collection",
					"action": "Search API for 'LiDAR Collection' entry type",
					"description": "API to search for entries of type LiDAR Collection",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/lidar_collection"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/lidar_collection",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
