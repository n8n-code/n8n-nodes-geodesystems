...
export const typeBlogentryDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Blogentry",
					"value": "Search Blogentry",
					"action": "Search API for 'Weblog Entry' entry type",
					"description": "API to search for entries of type Weblog Entry",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/blogentry"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/blogentry",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Blogentry Blogtext",
			"name": "search-blogentry-blogtext",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.blogentry.blogtext",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
