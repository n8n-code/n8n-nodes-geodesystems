...
export const typeTypePointSimpleRecordsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Simple Records"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Simple Records",
					"value": "Search Type Point Simple Records",
					"action": "Search API for 'Simple Records' entry type",
					"description": "API to search for entries of type Simple Records",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_simple_records"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_simple_records",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Simple Records"
					]
				}
			}
		},
