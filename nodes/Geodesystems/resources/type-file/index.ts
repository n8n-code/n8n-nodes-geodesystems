...
export const typeFileDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search File",
					"value": "Search File",
					"action": "Search API for 'File' entry type",
					"description": "API to search for entries of type File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/file"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/file",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
