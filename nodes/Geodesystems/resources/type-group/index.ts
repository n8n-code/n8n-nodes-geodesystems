...
export const typeGroupDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Group",
					"value": "Search Group",
					"action": "Search API for 'Folder' entry type",
					"description": "API to search for entries of type Folder",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/group"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/group",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
