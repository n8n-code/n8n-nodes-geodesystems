...
export const typeGadgetsStockDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Gadgets Stock",
					"value": "Search Gadgets Stock",
					"action": "Search API for 'Stock Ticker' entry type",
					"description": "API to search for entries of type Stock Ticker",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/gadgets_stock"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/gadgets_stock",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
