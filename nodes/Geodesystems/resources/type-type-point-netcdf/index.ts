...
export const typeTypePointNetcdfDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Netcdf"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Netcdf",
					"value": "Search Type Point Netcdf",
					"action": "Search API for 'NetCDF Point File' entry type",
					"description": "API to search for entries of type NetCDF Point File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_netcdf"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_netcdf",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
