...
export const typeTypeFredSeriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Fred Series"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Fred Series",
					"value": "Search Type Fred Series",
					"action": "Search API for 'FRED Series' entry type",
					"description": "API to search for entries of type FRED Series",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_fred_series"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_fred_series",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
