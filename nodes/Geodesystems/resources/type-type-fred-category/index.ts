...
export const typeTypeFredCategoryDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Fred Category"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Fred Category",
					"value": "Search Type Fred Category",
					"action": "Search API for 'FRED Category' entry type",
					"description": "API to search for entries of type FRED Category",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_fred_category"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_fred_category",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
