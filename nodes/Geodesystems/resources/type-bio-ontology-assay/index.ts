...
export const typeBioOntologyAssayDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Assay"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Assay",
					"value": "Search Bio Ontology Assay",
					"action": "Search API for 'Assay' entry type",
					"description": "API to search for entries of type Assay",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_assay"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_assay",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
