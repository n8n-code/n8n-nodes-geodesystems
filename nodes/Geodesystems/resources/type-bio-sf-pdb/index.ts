...
export const typeBioSfPdbDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Sf Pdb",
					"value": "Search Bio Sf Pdb",
					"action": "Search API for 'PDB Protein File' entry type",
					"description": "API to search for entries of type PDB Protein File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_sf_pdb"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_sf_pdb",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
