...
export const typeTypeExtremesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Extremes",
					"value": "Search Type Extremes",
					"action": "Search API for 'NOAA Extremes Data' entry type",
					"description": "API to search for entries of type NOAA Extremes Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_extremes"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_extremes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Extremes Region",
			"name": "search-type_extremes-region",
			"description": "US Climate Region",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_extremes.region",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Extremes Variable",
			"name": "search-type_extremes-variable",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_extremes.variable",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
