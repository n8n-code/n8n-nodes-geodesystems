...
export const typeTypeGtfsAgencyDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Gtfs Agency"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Gtfs Agency",
					"value": "Search Type Gtfs Agency",
					"action": "Search API for 'Transit Agency' entry type",
					"description": "API to search for entries of type Transit Agency",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_gtfs_agency"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_gtfs_agency",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
