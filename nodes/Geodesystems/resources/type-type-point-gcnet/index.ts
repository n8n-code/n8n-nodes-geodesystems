...
export const typeTypePointGcnetDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Gcnet"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Gcnet",
					"value": "Search Type Point Gcnet",
					"action": "Search API for 'GC-Net Point Data' entry type",
					"description": "API to search for entries of type GC-Net Point Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_gcnet"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_gcnet",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
