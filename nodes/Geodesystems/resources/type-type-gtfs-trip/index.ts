...
export const typeTypeGtfsTripDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Gtfs Trip",
					"value": "Search Type Gtfs Trip",
					"action": "Search API for 'Transit Trip' entry type",
					"description": "API to search for entries of type Transit Trip",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_gtfs_trip"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_gtfs_trip",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Gtfs Trip Trip ID",
			"name": "search-type_gtfs_trip-trip_id",
			"description": "Trip ID",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_trip.trip_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Gtfs Trip Stop Ids",
			"name": "search-type_gtfs_trip-stop_ids",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_trip.stop_ids",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Gtfs Trip Wheelchair Accessible",
			"name": "search-type_gtfs_trip-wheelchair_accessible",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_trip.wheelchair_accessible",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Gtfs Trip Bikes Allowed",
			"name": "search-type_gtfs_trip-bikes_allowed",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_trip.bikes_allowed",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
