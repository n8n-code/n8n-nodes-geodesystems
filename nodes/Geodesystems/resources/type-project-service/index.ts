...
export const typeProjectServiceDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"value": "Search Project Service",
					"action": "Search API for 'Data Access Service' entry type",
					"description": "API to search for entries of type Data Access Service",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_service"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_service",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Service Service Type",
			"name": "search-project_service-service_type",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_service.service_type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Service Provider",
			"name": "search-project_service-provider",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_service.provider",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
