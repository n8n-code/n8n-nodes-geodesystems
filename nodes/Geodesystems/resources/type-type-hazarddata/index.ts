...
export const typeTypeHazarddataDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Hazarddata"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Hazarddata",
					"value": "Search Type Hazarddata",
					"action": "Search API for 'Hazard Data' entry type",
					"description": "API to search for entries of type Hazard Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_hazarddata"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_hazarddata",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Hazarddata Source",
			"name": "search-type_hazarddata-source",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_hazarddata.source",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
