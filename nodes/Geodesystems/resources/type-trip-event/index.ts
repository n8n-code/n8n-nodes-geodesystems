...
export const typeTripEventDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Trip Event",
					"value": "Search Trip Event",
					"action": "Search API for 'Event' entry type",
					"description": "API to search for entries of type Event",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/trip_event"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/trip_event",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
