...
export const typeTypeEsriGeometryserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Geometryserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Geometryserver",
					"value": "Search Type Esri Geometryserver",
					"action": "Search API for 'ESRI Geometry Server' entry type",
					"description": "API to search for entries of type ESRI Geometry Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_geometryserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_geometryserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Esri Geometryserver"
					]
				}
			}
		},
