...
export const typeTripFlightDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Trip Flight",
					"value": "Search Trip Flight",
					"action": "Search API for 'Flight Leg' entry type",
					"description": "API to search for entries of type Flight Leg",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/trip_flight"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/trip_flight",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
