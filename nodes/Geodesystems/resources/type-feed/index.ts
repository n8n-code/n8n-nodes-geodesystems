...
export const typeFeedDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Feed",
					"value": "Search Feed",
					"action": "Search API for 'RSS/ATOM Feed' entry type",
					"description": "API to search for entries of type RSS/ATOM Feed",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/feed"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/feed",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
