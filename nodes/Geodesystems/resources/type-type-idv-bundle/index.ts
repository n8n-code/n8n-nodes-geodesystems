...
export const typeTypeIdvBundleDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Idv Bundle"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Idv Bundle",
					"value": "Search Type Idv Bundle",
					"action": "Search API for 'IDV Bundle' entry type",
					"description": "API to search for entries of type IDV Bundle",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_idv_bundle"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_idv_bundle",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
