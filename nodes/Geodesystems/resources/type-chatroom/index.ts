...
export const typeChatroomDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Chatroom",
					"value": "Search Chatroom",
					"action": "Search API for 'Chat Room' entry type",
					"description": "API to search for entries of type Chat Room",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/chatroom"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/chatroom",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
