...
export const typePasteitentryDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Pasteitentry",
					"value": "Search Pasteitentry",
					"action": "Search API for 'Paste Text Entry' entry type",
					"description": "API to search for entries of type Paste Text Entry",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/pasteitentry"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/pasteitentry",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
