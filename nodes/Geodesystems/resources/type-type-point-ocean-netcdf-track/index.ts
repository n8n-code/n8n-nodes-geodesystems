...
export const typeTypePointOceanNetcdfTrackDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean Netcdf Track"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean Netcdf Track",
					"value": "Search Type Point Ocean Netcdf Track",
					"action": "Search API for 'NetCDF Track Data' entry type",
					"description": "API to search for entries of type NetCDF Track Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_netcdf_track"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_netcdf_track",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean Netcdf Track"
					]
				}
			}
		},
