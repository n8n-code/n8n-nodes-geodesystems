...
export const typeTypeImageWebcamDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Image Webcam"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Image Webcam",
					"value": "Search Type Image Webcam",
					"action": "Search API for 'Webcam' entry type",
					"description": "API to search for entries of type Webcam",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_image_webcam"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_image_webcam",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
