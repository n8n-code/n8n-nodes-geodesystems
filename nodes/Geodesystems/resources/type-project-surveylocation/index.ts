...
export const typeProjectSurveylocationDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Surveylocation"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Surveylocation",
					"value": "Search Project Surveylocation",
					"action": "Search API for 'Survey Location' entry type",
					"description": "API to search for entries of type Survey Location",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_surveylocation"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_surveylocation",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
