...
export const typeGeoHdf5Description: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Geo Hdf 5",
					"value": "Search Geo Hdf 5",
					"action": "Search API for 'HDF5 File' entry type",
					"description": "API to search for entries of type HDF5 File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_hdf5"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_hdf5",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
