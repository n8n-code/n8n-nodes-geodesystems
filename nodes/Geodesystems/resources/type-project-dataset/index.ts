...
export const typeProjectDatasetDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Dataset",
					"value": "Search Project Dataset",
					"action": "Search API for 'Dataset' entry type",
					"description": "API to search for entries of type Dataset",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_dataset"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_dataset",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Dataset Dataset ID",
			"name": "search-project_dataset-dataset_id",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_dataset.dataset_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Dataset Data Type",
			"name": "search-project_dataset-data_type",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_dataset.data_type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Dataset Data Level",
			"name": "search-project_dataset-data_level",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_dataset.data_level",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
