...
export const typeOwlClassDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Owl Class",
					"value": "Search Owl Class",
					"action": "Search API for 'OWL Class' entry type",
					"description": "API to search for entries of type OWL Class",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/owl.class"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/owl.class",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
