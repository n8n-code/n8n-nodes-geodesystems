...
export const typeGridaggregationDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Gridaggregation",
					"value": "Search Gridaggregation",
					"action": "Search API for 'Grid Aggregation' entry type",
					"description": "API to search for entries of type Grid Aggregation",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/gridaggregation"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/gridaggregation",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
