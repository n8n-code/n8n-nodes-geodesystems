...
export const typeTypePointIcebridgeAtmIcessnDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Icebridge Atm Icessn"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Icebridge Atm Icessn",
					"value": "Search Type Point Icebridge Atm Icessn",
					"action": "Search API for 'ATM Ice SSN Data' entry type",
					"description": "API to search for entries of type ATM Ice SSN Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_icebridge_atm_icessn"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_icebridge_atm_icessn",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Icebridge Atm Icessn"
					]
				}
			}
		},
