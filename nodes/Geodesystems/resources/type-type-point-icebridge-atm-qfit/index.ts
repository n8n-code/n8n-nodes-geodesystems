...
export const typeTypePointIcebridgeAtmQfitDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Icebridge Atm Qfit"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Icebridge Atm Qfit",
					"value": "Search Type Point Icebridge Atm Qfit",
					"action": "Search API for 'ATM QFIT Data' entry type",
					"description": "API to search for entries of type ATM QFIT Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_icebridge_atm_qfit"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_icebridge_atm_qfit",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Icebridge Atm Qfit"
					]
				}
			}
		},
