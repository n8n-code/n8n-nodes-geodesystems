...
export const typeBoulderCrimesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Boulder Crimes",
					"value": "Search Boulder Crimes",
					"action": "Search API for 'Boulder Crime Reports' entry type",
					"description": "API to search for entries of type Boulder Crime Reports",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/boulder_crimes"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/boulder_crimes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Boulder Crimes Offense",
			"name": "search-db_boulder_crimes-offense",
			"description": "Offense",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_boulder_crimes.offense",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Boulder Crimes Reportdate",
			"name": "search-db_boulder_crimes-reportdate",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_boulder_crimes.reportdate",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Boulder Crimes Blockadd",
			"name": "search-db_boulder_crimes-blockadd",
			"description": "Address",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_boulder_crimes.blockadd",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Boulder Crimes Location",
			"name": "search-db_boulder_crimes-location",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_boulder_crimes.location",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
