...
export const typeTypeSoundingGsdDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Sounding Gsd"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Sounding Gsd",
					"value": "Search Type Sounding Gsd",
					"action": "Search API for 'GSD Sounding' entry type",
					"description": "API to search for entries of type GSD Sounding",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_sounding_gsd"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_sounding_gsd",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
