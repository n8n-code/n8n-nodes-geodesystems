...
export const typeLidarLvisDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Lidar Lvis",
					"value": "Search Lidar Lvis",
					"action": "Search API for 'LVIS Lidar Data' entry type",
					"description": "API to search for entries of type LVIS Lidar Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/lidar_lvis"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/lidar_lvis",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
