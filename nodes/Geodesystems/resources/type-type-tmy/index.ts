...
export const typeTypeTmyDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Tmy",
					"value": "Search Type Tmy",
					"action": "Search API for 'NREL TMY Data' entry type",
					"description": "API to search for entries of type NREL TMY Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_tmy"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_tmy",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
