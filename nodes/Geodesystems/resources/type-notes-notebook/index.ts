...
export const typeNotesNotebookDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Notes Notebook",
					"value": "Search Notes Notebook",
					"action": "Search API for 'Notebook' entry type",
					"description": "API to search for entries of type Notebook",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/notes_notebook"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/notes_notebook",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
