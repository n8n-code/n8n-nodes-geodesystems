...
export const typeProjectTermDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Term",
					"value": "Search Project Term",
					"action": "Search API for 'Vocabulary Term' entry type",
					"description": "API to search for entries of type Vocabulary Term",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_term"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_term",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Term Value",
			"name": "search-project_term-value",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_term.value",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
