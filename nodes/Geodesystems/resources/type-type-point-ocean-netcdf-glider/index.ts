...
export const typeTypePointOceanNetcdfGliderDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean Netcdf Glider"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean Netcdf Glider",
					"value": "Search Type Point Ocean Netcdf Glider",
					"action": "Search API for 'NetCDF Glider Data' entry type",
					"description": "API to search for entries of type NetCDF Glider Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_netcdf_glider"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_netcdf_glider",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean Netcdf Glider"
					]
				}
			}
		},
		...
		{
			"displayName": "Search Type Point Ocean Netcdf Track Platform",
			"name": "search-type_point_ocean_netcdf_track-platform",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_ocean_netcdf_track.platform",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
