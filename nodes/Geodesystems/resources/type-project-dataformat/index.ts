...
export const typeProjectDataformatDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Dataformat"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Dataformat",
					"value": "Search Project Dataformat",
					"action": "Search API for 'Data Format' entry type",
					"description": "API to search for entries of type Data Format",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_dataformat"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_dataformat",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Dataformat Data Type",
			"name": "search-project_dataformat-data_type",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_dataformat.data_type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Dataformat Field",
			"name": "search-project_dataformat-field",
			"description": "Field",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_dataformat.field",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
