...
export const typeGadgetsWeatherDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Gadgets Weather"
					]
				}
			},
			"options": [
				{
					"name": "Search Gadgets Weather",
					"value": "Search Gadgets Weather",
					"action": "Search API for 'Weather' entry type",
					"description": "API to search for entries of type Weather",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/gadgets_weather"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/gadgets_weather",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
