...
export const typeProjectOrganizationDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Organization",
					"value": "Search Project Organization",
					"action": "Search API for 'Organization' entry type",
					"description": "API to search for entries of type Organization",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_organization"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_organization",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Organization Organization Type",
			"name": "search-project_organization-organization_type",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_organization.organization_type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Organization Status",
			"name": "search-project_organization-status",
			"description": "Status",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_organization.status",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
