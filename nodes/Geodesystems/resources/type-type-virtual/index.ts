...
export const typeTypeVirtualDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Virtual",
					"value": "Search Type Virtual",
					"action": "Search API for 'Virtual Group' entry type",
					"description": "API to search for entries of type Virtual Group",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_virtual"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_virtual",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
