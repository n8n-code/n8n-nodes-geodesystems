...
export const typeTypeImageAirportDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Image Airport"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Image Airport",
					"value": "Search Type Image Airport",
					"action": "Search API for 'Airport Image' entry type",
					"description": "API to search for entries of type Airport Image",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_image_airport"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_image_airport",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
