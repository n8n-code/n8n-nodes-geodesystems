...
export const typeProjectGpsRawDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Gps Raw"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Gps Raw",
					"value": "Search Project Gps Raw",
					"action": "Search API for 'Raw GPS File' entry type",
					"description": "API to search for entries of type Raw GPS File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_gps_raw"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_gps_raw",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
