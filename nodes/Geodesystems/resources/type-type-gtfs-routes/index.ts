...
export const typeTypeGtfsRoutesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Gtfs Routes"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Gtfs Routes",
					"value": "Search Type Gtfs Routes",
					"action": "Search API for 'Transit Route Collection' entry type",
					"description": "API to search for entries of type Transit Route Collection",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_gtfs_routes"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_gtfs_routes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
