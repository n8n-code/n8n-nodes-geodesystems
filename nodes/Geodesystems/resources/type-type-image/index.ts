...
export const typeTypeImageDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Image",
					"value": "Search Type Image",
					"action": "Search API for 'Image' entry type",
					"description": "API to search for entries of type Image",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_image"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_image",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
