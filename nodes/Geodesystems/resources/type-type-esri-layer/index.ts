...
export const typeTypeEsriLayerDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Layer"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Layer",
					"value": "Search Type Esri Layer",
					"action": "Search API for 'ESRI Layer' entry type",
					"description": "API to search for entries of type ESRI Layer",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_layer"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_layer",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Esri Layer Layer Type",
			"name": "search-type_esri_layer-layer_type",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_esri_layer.layer_type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
