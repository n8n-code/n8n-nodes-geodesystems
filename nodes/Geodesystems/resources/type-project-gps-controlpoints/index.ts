...
export const typeProjectGpsControlpointsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Gps Controlpoints"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Gps Controlpoints",
					"value": "Search Project Gps Controlpoints",
					"action": "Search API for 'Control Points File' entry type",
					"description": "API to search for entries of type Control Points File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_gps_controlpoints"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_gps_controlpoints",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Project Gps Controlpoints"
					]
				}
			}
		},
