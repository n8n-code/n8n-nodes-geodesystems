...
export const typeTypePointCzoDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Point Czo",
					"value": "Search Type Point Czo",
					"action": "Search API for 'CZO Display File Format' entry type",
					"description": "API to search for entries of type CZO Display File Format",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_czo"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_czo",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
