...
export const typeTypeDocumentCsvDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Document CSV"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Document CSV",
					"value": "Search Type Document CSV",
					"action": "Search API for 'CSV File' entry type",
					"description": "API to search for entries of type CSV File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_csv"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_csv",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
