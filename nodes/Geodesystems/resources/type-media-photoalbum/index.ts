...
export const typeMediaPhotoalbumDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Photoalbum"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Photoalbum",
					"value": "Search Media Photoalbum",
					"action": "Search API for 'Photo Album' entry type",
					"description": "API to search for entries of type Photo Album",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_photoalbum"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_photoalbum",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
