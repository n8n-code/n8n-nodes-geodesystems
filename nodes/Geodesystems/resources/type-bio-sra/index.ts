...
export const typeBioSraDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Sra",
					"value": "Search Bio Sra",
					"action": "Search API for 'Sequence Read Archive' entry type",
					"description": "API to search for entries of type Sequence Read Archive",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_sra"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_sra",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
