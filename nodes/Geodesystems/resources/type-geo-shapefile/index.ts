...
export const typeGeoShapefileDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Geo Shapefile",
					"value": "Search Geo Shapefile",
					"action": "Search API for 'Shapefile' entry type",
					"description": "API to search for entries of type Shapefile",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_shapefile"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_shapefile",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
