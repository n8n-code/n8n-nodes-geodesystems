...
export const typeBioFastaDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Fasta",
					"value": "Search Bio Fasta",
					"action": "Search API for 'FASTA File' entry type",
					"description": "API to search for entries of type FASTA File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_fasta"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_fasta",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
