...
export const typePointTextDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Point Text",
					"value": "Search Point Text",
					"action": "Search API for 'Text Point Data' entry type",
					"description": "API to search for entries of type Text Point Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/point_text"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/point_text",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
