...
export const typeLinkDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Link",
					"value": "Search Link",
					"action": "Search API for 'Link' entry type",
					"description": "API to search for entries of type Link",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/link"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/link",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
