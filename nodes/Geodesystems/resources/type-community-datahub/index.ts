...
export const typeCommunityDatahubDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Community Datahub"
					]
				}
			},
			"options": [
				{
					"name": "Search Community Datahub",
					"value": "Search Community Datahub",
					"action": "Search API for 'Data Hub' entry type",
					"description": "API to search for entries of type Data Hub",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/community_datahub"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/community_datahub",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
