...
export const typeTypeEiaCategoryDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Eia Category"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Eia Category",
					"value": "Search Type Eia Category",
					"action": "Search API for 'EIA Category' entry type",
					"description": "API to search for entries of type EIA Category",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_eia_category"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_eia_category",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
