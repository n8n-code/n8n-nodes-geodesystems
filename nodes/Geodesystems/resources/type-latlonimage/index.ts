...
export const typeLatlonimageDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Latlonimage",
					"value": "Search Latlonimage",
					"action": "Search API for 'Lat-Lon Image' entry type",
					"description": "API to search for entries of type Lat-Lon Image",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/latlonimage"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/latlonimage",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
