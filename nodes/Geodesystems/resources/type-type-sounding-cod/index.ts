...
export const typeTypeSoundingCodDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Sounding Cod"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Sounding Cod",
					"value": "Search Type Sounding Cod",
					"action": "Search API for 'COD Sounding' entry type",
					"description": "API to search for entries of type COD Sounding",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_sounding_cod"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_sounding_cod",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
