...
export const typeProjectLearningResourceDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Learning Resource"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Learning Resource",
					"value": "Search Project Learning Resource",
					"action": "Search API for 'Teaching Resource' entry type",
					"description": "API to search for entries of type Teaching Resource",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_learning_resource"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_learning_resource",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Project Learning Resource"
					]
				}
			}
		},
		...
		{
			"displayName": "Search Project Learning Resource Topic",
			"name": "search-project_learning_resource-topic",
			"description": "Topic",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_learning_resource.topic",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Learning Resource Grade Level",
			"name": "search-project_learning_resource-grade_level",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_learning_resource.grade_level",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
