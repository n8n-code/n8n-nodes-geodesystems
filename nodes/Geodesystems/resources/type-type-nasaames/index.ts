...
export const typeTypeNasaamesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Nasaames",
					"value": "Search Type Nasaames",
					"action": "Search API for 'NASA AMES File' entry type",
					"description": "API to search for entries of type NASA AMES File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_nasaames"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_nasaames",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
