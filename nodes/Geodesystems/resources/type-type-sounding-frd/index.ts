...
export const typeTypeSoundingFrdDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Sounding Frd"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Sounding Frd",
					"value": "Search Type Sounding Frd",
					"action": "Search API for 'FRD Sounding' entry type",
					"description": "API to search for entries of type FRD Sounding",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_sounding_frd"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_sounding_frd",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
