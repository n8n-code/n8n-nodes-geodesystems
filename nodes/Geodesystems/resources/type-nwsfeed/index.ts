...
export const typeNwsfeedDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Nwsfeed",
					"value": "Search Nwsfeed",
					"action": "Search API for 'NWS Forecast Feed' entry type",
					"description": "API to search for entries of type NWS Forecast Feed",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/nwsfeed"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/nwsfeed",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
