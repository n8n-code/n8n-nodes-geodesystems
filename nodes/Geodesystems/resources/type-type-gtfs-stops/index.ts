...
export const typeTypeGtfsStopsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Gtfs Stops"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Gtfs Stops",
					"value": "Search Type Gtfs Stops",
					"action": "Search API for 'Transit Stop Collection' entry type",
					"description": "API to search for entries of type Transit Stop Collection",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_gtfs_stops"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_gtfs_stops",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
