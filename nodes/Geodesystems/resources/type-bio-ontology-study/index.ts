...
export const typeBioOntologyStudyDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Study"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Study",
					"value": "Search Bio Ontology Study",
					"action": "Search API for 'Study' entry type",
					"description": "API to search for entries of type Study",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_study"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_study",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
