...
export const typeTypePointNoaaTowerDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Noaa Tower"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Noaa Tower",
					"value": "Search Type Point Noaa Tower",
					"action": "Search API for 'NOAA Tower Network' entry type",
					"description": "API to search for entries of type NOAA Tower Network",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_noaa_tower"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_noaa_tower",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Point Noaa Tower Site ID",
			"name": "search-type_point_noaa_tower-site_id",
			"description": "Site ID",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_noaa_tower.site_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
