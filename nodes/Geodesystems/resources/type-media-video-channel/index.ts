...
export const typeMediaVideoChannelDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Video Channel"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Video Channel",
					"value": "Search Media Video Channel",
					"action": "Search API for 'Video Channel' entry type",
					"description": "API to search for entries of type Video Channel",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_video_channel"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_video_channel",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
