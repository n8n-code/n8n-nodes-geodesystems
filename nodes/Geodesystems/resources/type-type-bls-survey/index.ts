...
export const typeTypeBlsSurveyDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Bls Survey"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Bls Survey",
					"value": "Search Type Bls Survey",
					"action": "Search API for 'BLS Survey' entry type",
					"description": "API to search for entries of type BLS Survey",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_bls_survey"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_bls_survey",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
