...
export const typeGeoGeDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Geo Geojson",
					"value": "Search Geo Geojson",
					"action": "Search API for 'GeoJson File' entry type",
					"description": "API to search for entries of type GeoJson File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_geojson"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_geojson",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
