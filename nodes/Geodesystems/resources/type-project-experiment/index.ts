...
export const typeProjectExperimentDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Experiment",
					"value": "Search Project Experiment",
					"action": "Search API for 'Experiment' entry type",
					"description": "API to search for entries of type Experiment",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_experiment"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_experiment",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
