...
export const typeStatusboardDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Statusboard",
					"value": "Search Statusboard",
					"action": "Search API for 'Status Board' entry type",
					"description": "API to search for entries of type Status Board",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/statusboard"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/statusboard",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Statusboard What",
			"name": "search-db_statusboard-what",
			"description": "What",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_statusboard.what",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Statusboard Status",
			"name": "search-db_statusboard-status",
			"description": "Status",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_statusboard.status",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
