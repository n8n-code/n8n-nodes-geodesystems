...
export const typeProjectCampaignDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Campaign",
					"value": "Search Project Campaign",
					"action": "Search API for 'Campaign' entry type",
					"description": "API to search for entries of type Campaign",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_campaign"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_campaign",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
