...
export const typeTypeTweetDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Tweet",
					"value": "Search Type Tweet",
					"action": "Search API for 'Tweet' entry type",
					"description": "API to search for entries of type Tweet",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_tweet"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_tweet",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
