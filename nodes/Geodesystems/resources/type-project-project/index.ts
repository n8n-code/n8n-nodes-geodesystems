...
export const typeProjectProjectDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"action": "Search API for 'Project' entry type",
					"description": "API to search for entries of type Project",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_project"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_project",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
