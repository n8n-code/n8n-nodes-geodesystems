...
export const typeHipchatGroupDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Hipchat Group",
					"value": "Search Hipchat Group",
					"action": "Search API for 'HipChat Group' entry type",
					"description": "API to search for entries of type HipChat Group",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/hipchat_group"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/hipchat_group",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
