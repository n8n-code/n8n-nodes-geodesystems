...
export const typeBioOntologyCohortDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Cohort"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Cohort",
					"value": "Search Bio Ontology Cohort",
					"action": "Search API for 'Cohort' entry type",
					"description": "API to search for entries of type Cohort",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_cohort"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_cohort",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
