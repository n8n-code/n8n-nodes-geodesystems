...
export const typeTripHotelDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Trip Hotel",
					"value": "Search Trip Hotel",
					"action": "Search API for 'Lodging' entry type",
					"description": "API to search for entries of type Lodging",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/trip_hotel"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/trip_hotel",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
