...
export const typeTypeDocumentPptDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Document Ppt"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Document Ppt",
					"value": "Search Type Document Ppt",
					"action": "Search API for 'Powerpoint File' entry type",
					"description": "API to search for entries of type Powerpoint File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_ppt"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_ppt",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
