...
export const typeProjectDeploymentDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Deployment",
					"value": "Search Project Deployment",
					"action": "Search API for 'Deployment' entry type",
					"description": "API to search for entries of type Deployment",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_deployment"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_deployment",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
