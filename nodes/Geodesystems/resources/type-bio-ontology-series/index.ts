...
export const typeBioOntologySeriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Series"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Series",
					"value": "Search Bio Ontology Series",
					"action": "Search API for 'Series' entry type",
					"description": "API to search for entries of type Series",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_series"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_series",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
