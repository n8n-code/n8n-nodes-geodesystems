...
export const typeCalendarDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"value": "Search Calendar",
					"action": "Search API for 'Calendar' entry type",
					"description": "API to search for entries of type Calendar",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/calendar"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/calendar",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
