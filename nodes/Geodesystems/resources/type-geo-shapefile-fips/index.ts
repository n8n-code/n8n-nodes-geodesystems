...
export const typeGeoShapefileFipsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Geo Shapefile Fips"
					]
				}
			},
			"options": [
				{
					"name": "Search Geo Shapefile Fips",
					"value": "Search Geo Shapefile Fips",
					"action": "Search API for 'Shapefile with FIPS Code' entry type",
					"description": "API to search for entries of type Shapefile with FIPS Code",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_shapefile_fips"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_shapefile_fips",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
