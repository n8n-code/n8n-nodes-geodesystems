...
export const typeOwlOntologyDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Owl Ontology",
					"value": "Search Owl Ontology",
					"action": "Search API for 'OWL Ontology' entry type",
					"description": "API to search for entries of type OWL Ontology",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/owl.ontology"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/owl.ontology",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
