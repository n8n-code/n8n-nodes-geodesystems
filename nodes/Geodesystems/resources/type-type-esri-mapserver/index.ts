...
export const typeTypeEsriMapserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Mapserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Mapserver",
					"value": "Search Type Esri Mapserver",
					"action": "Search API for 'ESRI Map Server' entry type",
					"description": "API to search for entries of type ESRI Map Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_mapserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_mapserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
