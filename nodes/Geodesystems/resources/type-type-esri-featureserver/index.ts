...
export const typeTypeEsriFeatureserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Featureserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Featureserver",
					"value": "Search Type Esri Featureserver",
					"action": "Search API for 'ESRI Feature Server' entry type",
					"description": "API to search for entries of type ESRI Feature Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_featureserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_featureserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Esri Featureserver"
					]
				}
			}
		},
