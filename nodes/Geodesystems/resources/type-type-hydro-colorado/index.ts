...
export const typeTypeHydroColoradoDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Hydro Colorado"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Hydro Colorado",
					"value": "Search Type Hydro Colorado",
					"action": "Search API for 'Colorado DNR Stream Gage' entry type",
					"description": "API to search for entries of type Colorado DNR Stream Gage",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_hydro_colorado"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_hydro_colorado",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Hydro Colorado Site ID",
			"name": "search-type_hydro_colorado-site_id",
			"description": "Site ID",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_hydro_colorado.site_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
