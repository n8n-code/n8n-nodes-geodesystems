...
export const typeTypePointNoaaMadisDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Noaa Madis"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Noaa Madis",
					"value": "Search Type Point Noaa Madis",
					"action": "Search API for 'NOAA MADIS Point Data' entry type",
					"description": "API to search for entries of type NOAA MADIS Point Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_noaa_madis"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_noaa_madis",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
