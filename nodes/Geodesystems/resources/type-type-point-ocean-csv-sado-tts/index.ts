...
export const typeTypePointOceanCsvSadoTtsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean CSV Sado TTS"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean CSV Sado TTS",
					"value": "Search Type Point Ocean CSV Sado TTS",
					"action": "Search API for 'SADO TTS Data' entry type",
					"description": "API to search for entries of type SADO TTS Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_csv_sado_TTS"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_csv_sado_TTS",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean CSV Sado TTS"
					]
				}
			}
		},
