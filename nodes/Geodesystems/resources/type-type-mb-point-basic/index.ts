...
export const typeTypeMbPointBasicDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Mb Point Basic"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Mb Point Basic",
					"value": "Search Type Mb Point Basic",
					"action": "Search API for 'Basic MB point file' entry type",
					"description": "API to search for entries of type Basic MB point file",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_mb_point_basic"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_mb_point_basic",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
