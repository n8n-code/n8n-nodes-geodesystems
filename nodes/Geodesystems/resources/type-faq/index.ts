...
export const typeFaqDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Faq",
					"value": "Search Faq",
					"action": "Search API for 'FAQ' entry type",
					"description": "API to search for entries of type FAQ",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/faq"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/faq",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
