...
export const typeNotesNoteDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Notes Note",
					"value": "Search Notes Note",
					"action": "Search API for 'Note' entry type",
					"description": "API to search for entries of type Note",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/notes_note"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/notes_note",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
