...
export const typeBioStockholmDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Stockholm",
					"value": "Search Bio Stockholm",
					"action": "Search API for 'Stockholm File' entry type",
					"description": "API to search for entries of type Stockholm File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_stockholm"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_stockholm",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
