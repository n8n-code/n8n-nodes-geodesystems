...
export const typeGadgetsCountdownDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Gadgets Countdown"
					]
				}
			},
			"options": [
				{
					"name": "Search Gadgets Countdown",
					"value": "Search Gadgets Countdown",
					"action": "Search API for 'Countdown' entry type",
					"description": "API to search for entries of type Countdown",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/gadgets_countdown"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/gadgets_countdown",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
