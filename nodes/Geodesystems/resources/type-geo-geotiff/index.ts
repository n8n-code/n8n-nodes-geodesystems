...
export const typeGeoGeotiffDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Geo Geotiff",
					"value": "Search Geo Geotiff",
					"action": "Search API for 'GeoTIFF' entry type",
					"description": "API to search for entries of type GeoTIFF",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_geotiff"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_geotiff",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
