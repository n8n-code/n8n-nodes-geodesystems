...
export const typeHomepageDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"action": "Search API for 'Home Page' entry type",
					"description": "API to search for entries of type Home Page",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/homepage"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/homepage",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
