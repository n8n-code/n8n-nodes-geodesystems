...
export const typeSunrisesunsetDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Sunrisesunset",
					"value": "Search Sunrisesunset",
					"action": "Search API for 'Sunrise/Sunset Display' entry type",
					"description": "API to search for entries of type Sunrise/Sunset Display",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/sunrisesunset"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/sunrisesunset",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
