...
export const typeTypeSocrataSeriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Socrata Series"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Socrata Series",
					"value": "Search Type Socrata Series",
					"action": "Search API for 'SOCRATA Series' entry type",
					"description": "API to search for entries of type SOCRATA Series",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_socrata_series"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_socrata_series",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
