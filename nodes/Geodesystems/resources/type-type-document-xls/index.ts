...
export const typeTypeDocumentXlsDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Document Xls"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Document Xls",
					"value": "Search Type Document Xls",
					"action": "Search API for 'Excel File' entry type",
					"description": "API to search for entries of type Excel File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_xls"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_xls",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
