...
export const typeProjectContributionDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Contribution",
					"value": "Search Project Contribution",
					"action": "Search API for 'Research Contribution' entry type",
					"description": "API to search for entries of type Research Contribution",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_contribution"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_contribution",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
