...
export const typeIncidentDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"value": "Search Incident",
					"action": "Search API for 'Incident' entry type",
					"description": "API to search for entries of type Incident",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/incident"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/incident",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Incident Incidenttype",
			"name": "search-incident-incidenttype",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.incident.incidenttype",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Incident Cause",
			"name": "search-incident-cause",
			"description": "Cause",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.incident.cause",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Incident State",
			"name": "search-incident-state",
			"description": "State",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.incident.state",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
