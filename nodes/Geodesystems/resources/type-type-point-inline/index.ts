...
export const typeTypePointInlineDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Inline"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Inline",
					"value": "Search Type Point Inline",
					"action": "Search API for 'Inline Point File' entry type",
					"description": "API to search for entries of type Inline Point File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_inline"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_inline",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
