...
export const typeTypePointOceanCsvSadoMeteoDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean CSV Sado Meteo"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean CSV Sado Meteo",
					"value": "Search Type Point Ocean CSV Sado Meteo",
					"action": "Search API for 'SADO Meteo Data' entry type",
					"description": "API to search for entries of type SADO Meteo Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_csv_sado_meteo"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_csv_sado_meteo",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean CSV Sado Meteo"
					]
				}
			}
		},
