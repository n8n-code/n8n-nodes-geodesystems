...
export const typeNotesJsonfileDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Notes Jsonfile",
					"value": "Search Notes Jsonfile",
					"action": "Search API for 'Json File' entry type",
					"description": "API to search for entries of type Json File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/notes_jsonfile"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/notes_jsonfile",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
