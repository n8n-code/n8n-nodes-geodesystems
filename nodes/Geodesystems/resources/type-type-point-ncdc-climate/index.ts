...
export const typeTypePointNcdcClimateDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ncdc Climate"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ncdc Climate",
					"value": "Search Type Point Ncdc Climate",
					"action": "Search API for 'NC  DC Climate Data' entry type",
					"description": "API to search for entries of type NC  DC Climate Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ncdc_climate"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ncdc_climate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ncdc Climate"
					]
				}
			}
		},
