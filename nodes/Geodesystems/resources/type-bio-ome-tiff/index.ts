...
export const typeBioOmeTiffDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Ome Tiff",
					"value": "Search Bio Ome Tiff",
					"action": "Search API for 'OME TIFF File' entry type",
					"description": "API to search for entries of type OME TIFF File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ome_tiff"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ome_tiff",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
