...
export const typeProjectFieldnoteDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Fieldnote"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Fieldnote",
					"value": "Search Project Fieldnote",
					"action": "Search API for 'Field Note' entry type",
					"description": "API to search for entries of type Field Note",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_fieldnote"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_fieldnote",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
