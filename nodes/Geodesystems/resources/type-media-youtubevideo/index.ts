...
export const typeMediaYoutubevideoDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Youtubevideo"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Youtubevideo",
					"value": "Search Media Youtubevideo",
					"action": "Search API for 'YouTube Video' entry type",
					"description": "API to search for entries of type YouTube Video",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_youtubevideo"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_youtubevideo",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
