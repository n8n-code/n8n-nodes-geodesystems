...
export const typeCataloglinkDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Cataloglink",
					"value": "Search Cataloglink",
					"action": "Search API for 'Catalog Link' entry type",
					"description": "API to search for entries of type Catalog Link",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/cataloglink"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/cataloglink",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
