...
export const typeGeoKmlDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Geo Kml",
					"value": "Search Geo Kml",
					"action": "Search API for 'KML/KMZ File' entry type",
					"description": "API to search for entries of type KML/KMZ File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/geo_kml"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/geo_kml",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
