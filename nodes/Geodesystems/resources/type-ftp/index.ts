...
export const typeFtpDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search FTP",
					"value": "Search FTP",
					"action": "Search API for 'Remote FTP File View' entry type",
					"description": "API to search for entries of type Remote FTP File View",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/ftp"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/ftp",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
