...
export const typeTypeSoundingWyomingDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Sounding Wyoming"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Sounding Wyoming",
					"value": "Search Type Sounding Wyoming",
					"action": "Search API for 'UW Sounding' entry type",
					"description": "API to search for entries of type UW Sounding",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_sounding_wyoming"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_sounding_wyoming",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
