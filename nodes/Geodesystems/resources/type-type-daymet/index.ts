...
export const typeTypeDaymetDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Daymet",
					"value": "Search Type Daymet",
					"action": "Search API for 'Daymet Daily Weather' entry type",
					"description": "API to search for entries of type Daymet Daily Weather",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_daymet"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_daymet",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
