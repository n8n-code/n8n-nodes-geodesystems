...
export const typeNotesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Notes",
					"value": "Search Notes",
					"action": "Search API for 'Notes' entry type",
					"description": "API to search for entries of type Notes",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/notes"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/notes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Notes Note",
			"name": "search-db_notes-note",
			"description": "Note",
			"default": "",
			"type": "string",
			"routing": {
