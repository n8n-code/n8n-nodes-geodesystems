...
export const typeBioDicomDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Dicom",
					"value": "Search Bio Dicom",
					"action": "Search API for 'DICOM File' entry type",
					"description": "API to search for entries of type DICOM File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_dicom"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_dicom",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
