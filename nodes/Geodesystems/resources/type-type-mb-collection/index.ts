...
export const typeTypeMbCollectionDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Mb Collection"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Mb Collection",
					"value": "Search Type Mb Collection",
					"action": "Search API for 'Bathymetry Collection' entry type",
					"description": "API to search for entries of type Bathymetry Collection",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_mb_collection"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_mb_collection",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
