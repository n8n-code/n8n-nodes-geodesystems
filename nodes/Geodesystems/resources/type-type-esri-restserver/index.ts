...
export const typeTypeEsriRestserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Restserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Restserver",
					"value": "Search Type Esri Restserver",
					"action": "Search API for 'ESRI Web Server' entry type",
					"description": "API to search for entries of type ESRI Web Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_restserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_restserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
