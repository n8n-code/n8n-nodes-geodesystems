...
export const typeProjectProgramDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Program",
					"value": "Search Project Program",
					"action": "Search API for 'Program' entry type",
					"description": "API to search for entries of type Program",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_program"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_program",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
