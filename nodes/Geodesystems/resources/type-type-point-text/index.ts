...
export const typeTypePointTextDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Text"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Text",
					"value": "Search Type Point Text",
					"action": "Search API for 'Record Text File' entry type",
					"description": "API to search for entries of type Record Text File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_text"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_text",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
