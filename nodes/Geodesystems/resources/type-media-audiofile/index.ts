...
export const typeMediaAudiofileDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Audiofile"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Audiofile",
					"value": "Search Media Audiofile",
					"action": "Search API for 'Audio File' entry type",
					"description": "API to search for entries of type Audio File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_audiofile"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_audiofile",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
