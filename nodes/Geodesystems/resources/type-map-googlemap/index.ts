...
export const typeMapGooglemapDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Map Googlemap",
					"value": "Search Map Googlemap",
					"action": "Search API for 'Google Map URL' entry type",
					"description": "API to search for entries of type Google Map URL",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/map_googlemap"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/map_googlemap",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
