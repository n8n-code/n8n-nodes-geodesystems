...
export const typeTypeDocumentHtmlDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Document HTML"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Document HTML",
					"value": "Search Type Document HTML",
					"action": "Search API for 'HTML File' entry type",
					"description": "API to search for entries of type HTML File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_html"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_html",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
