...
export const typeTypeEsriGpserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Gpserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Gpserver",
					"value": "Search Type Esri Gpserver",
					"action": "Search API for 'ESRI GP Server' entry type",
					"description": "API to search for entries of type ESRI GP Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_gpserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_gpserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
