...
export const typeTypePointHydroWatermlDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Hydro Waterml"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Hydro Waterml",
					"value": "Search Type Point Hydro Waterml",
					"action": "Search API for 'WaterML' entry type",
					"description": "API to search for entries of type WaterML",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_hydro_waterml"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_hydro_waterml",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Hydro Waterml"
					]
				}
			}
		},
		...
		{
			"displayName": "Search Type Point Hydro Waterml Site Code",
			"name": "search-type_point_hydro_waterml-site_code",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_hydro_waterml.site_code",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Point Hydro Waterml Site Name",
			"name": "search-type_point_hydro_waterml-site_name",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_hydro_waterml.site_name",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
