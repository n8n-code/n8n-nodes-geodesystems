...
export const typeTypeWmsCapabilitiesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Wms Capabilities"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Wms Capabilities",
					"value": "Search Type Wms Capabilities",
					"action": "Search API for 'WMS Capabilities' entry type",
					"description": "API to search for entries of type WMS Capabilities",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_wms_capabilities"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_wms_capabilities",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
