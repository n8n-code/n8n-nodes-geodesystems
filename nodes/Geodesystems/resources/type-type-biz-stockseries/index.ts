...
export const typeTypeBizStockseriesDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Biz Stockseries"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Biz Stockseries",
					"value": "Search Type Biz Stockseries",
					"action": "Search API for 'Stock Ticker Data' entry type",
					"description": "API to search for entries of type Stock Ticker Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_biz_stockseries"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_biz_stockseries",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
