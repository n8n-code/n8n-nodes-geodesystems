...
export const typeProjectGpsRinexDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Gps Rinex"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Gps Rinex",
					"value": "Search Project Gps Rinex",
					"action": "Search API for 'RINEX File' entry type",
					"description": "API to search for entries of type RINEX File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_gps_rinex"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_gps_rinex",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
