...
export const typeTypeServiceLinkDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Service Link"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Service Link",
					"value": "Search Type Service Link",
					"action": "Search API for 'Service Link' entry type",
					"description": "API to search for entries of type Service Link",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_service_link"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_service_link",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
