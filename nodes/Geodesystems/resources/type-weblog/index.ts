...
export const typeWeblogDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Weblog",
					"value": "Search Weblog",
					"action": "Search API for 'Weblog' entry type",
					"description": "API to search for entries of type Weblog",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/weblog"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/weblog",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
