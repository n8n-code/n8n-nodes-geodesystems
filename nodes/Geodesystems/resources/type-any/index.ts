...
export const typeAnyDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Any",
					"value": "Search Any",
					"action": "Search API for 'Any file type' entry type",
					"description": "API to search for entries of type Any file type",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/any"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/any",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
