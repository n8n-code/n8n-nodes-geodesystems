...
export const typeBioOntologySampleDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Sample"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Sample",
					"value": "Search Bio Ontology Sample",
					"action": "Search API for 'Sample' entry type",
					"description": "API to search for entries of type Sample",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_sample"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_sample",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
