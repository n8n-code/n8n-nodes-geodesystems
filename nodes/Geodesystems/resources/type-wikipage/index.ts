...
export const typeWikipageDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Wikipage",
					"value": "Search Wikipage",
					"action": "Search API for 'Wiki Page' entry type",
					"description": "API to search for entries of type Wiki Page",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/wikipage"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/wikipage",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Wikipage Wikitext",
			"name": "search-wikipage-wikitext",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.wikipage.wikitext",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Wikipage Category",
			"name": "search-wikipage-category",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.wikipage.category",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
