...
export const typeTodoDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Todo",
					"value": "Search Todo",
					"action": "Search API for 'Todo' entry type",
					"description": "API to search for entries of type Todo",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/todo"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/todo",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Todo Checked",
			"name": "search-db_todo-checked",
			"description": "Done",
			"default": true,
			"type": "boolean",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_todo.checked",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Todo Title",
			"name": "search-db_todo-title",
			"description": "What",
			"default": "",
			"type": "string",
			"routing": {
		...
		{
			"displayName": "Search DB Todo Category",
			"name": "search-db_todo-category",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_todo.category",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
