...
export const typeTypeDrilsdownCasestudyDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Drilsdown Casestudy"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Drilsdown Casestudy",
					"value": "Search Type Drilsdown Casestudy",
					"action": "Search API for 'Drilsdown Case Study' entry type",
					"description": "API to search for entries of type Drilsdown Case Study",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_drilsdown_casestudy"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_drilsdown_casestudy",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Drilsdown Casestudy"
					]
				}
			}
		},
