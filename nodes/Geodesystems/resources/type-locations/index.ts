...
export const typeLocationsDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"action": "Search API for 'Locations' entry type",
					"description": "API to search for entries of type Locations",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/locations"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/locations",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search DB Locations Name",
			"name": "search-db_locations-name",
			"description": "Name",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_locations.name",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Locations Type",
			"name": "search-db_locations-type",
			"description": "Type",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_locations.type",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search DB Locations Location",
			"name": "search-db_locations-location",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.db_locations.location",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
