...
export const typeTripReportDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Trip Report",
					"value": "Search Trip Report",
					"action": "Search API for 'Trip Report' entry type",
					"description": "API to search for entries of type Trip Report",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/trip_report"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/trip_report",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
