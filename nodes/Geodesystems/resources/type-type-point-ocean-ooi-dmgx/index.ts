...
export const typeTypePointOceanOoiDmgxDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Ocean Ooi Dmgx"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Ocean Ooi Dmgx",
					"value": "Search Type Point Ocean Ooi Dmgx",
					"action": "Search API for 'OOI Data' entry type",
					"description": "API to search for entries of type OOI Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_ocean_ooi_dmgx"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_ocean_ooi_dmgx",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Ocean Ooi Dmgx"
					]
				}
			}
		},
