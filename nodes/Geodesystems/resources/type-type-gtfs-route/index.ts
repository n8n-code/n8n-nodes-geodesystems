...
export const typeTypeGtfsRouteDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Gtfs Route"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Gtfs Route",
					"value": "Search Type Gtfs Route",
					"action": "Search API for 'Transit Route' entry type",
					"description": "API to search for entries of type Transit Route",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_gtfs_route"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_gtfs_route",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Gtfs Route Route ID",
			"name": "search-type_gtfs_route-route_id",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_route.route_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Gtfs Route Stop Names",
			"name": "search-type_gtfs_route-stop_names",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_gtfs_route.stop_names",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
