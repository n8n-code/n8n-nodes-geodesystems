...
export const typeTypePointIcebridgeMccordsIrmcr3Description: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Icebridge Mccords Irmcr 3"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Icebridge Mccords Irmcr 3",
					"value": "Search Type Point Icebridge Mccords Irmcr 3",
					"action": "Search API for 'McCords Irmcr3 Data' entry type",
					"description": "API to search for entries of type McCords Irmcr3 Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_icebridge_mccords_irmcr3"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_icebridge_mccords_irmcr3",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Icebridge Mccords Irmcr 3"
					]
				}
			}
		},
