...
export const typeMediaImageloopDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Imageloop"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Imageloop",
					"value": "Search Media Imageloop",
					"action": "Search API for 'Image Loop' entry type",
					"description": "API to search for entries of type Image Loop",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_imageloop"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_imageloop",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
