...
export const typeTypeNitfDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Nitf",
					"value": "Search Type Nitf",
					"action": "Search API for 'NITF File' entry type",
					"description": "API to search for entries of type NITF File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_nitf"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_nitf",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
