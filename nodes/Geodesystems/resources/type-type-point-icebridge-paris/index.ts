...
export const typeTypePointIcebridgeParisDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Icebridge Paris"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Icebridge Paris",
					"value": "Search Type Point Icebridge Paris",
					"action": "Search API for 'Paris Data' entry type",
					"description": "API to search for entries of type Paris Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_icebridge_paris"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_icebridge_paris",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Icebridge Paris"
					]
				}
			}
		},
