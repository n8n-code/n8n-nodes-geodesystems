...
export const typeProjectMeetingDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Meeting",
					"value": "Search Project Meeting",
					"action": "Search API for 'Meeting' entry type",
					"description": "API to search for entries of type Meeting",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_meeting"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_meeting",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Meeting Topic",
			"name": "search-project_meeting-topic",
			"description": "Topic",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_meeting.topic",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Meeting Location",
			"name": "search-project_meeting-location",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_meeting.location",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Meeting Participants",
			"name": "search-project_meeting-participants",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_meeting.participants",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
