...
export const typeProjectVocabularyDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Project Vocabulary",
					"value": "Search Project Vocabulary",
					"action": "Search API for 'Vocabulary' entry type",
					"description": "API to search for entries of type Vocabulary",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_vocabulary"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_vocabulary",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
