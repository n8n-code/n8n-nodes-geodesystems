...
export const typeMediaVideoQuicktimeDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Media Video Quicktime"
					]
				}
			},
			"options": [
				{
					"name": "Search Media Video Quicktime",
					"value": "Search Media Video Quicktime",
					"action": "Search API for 'Quicktime Video' entry type",
					"description": "API to search for entries of type Quicktime Video",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/media_video_quicktime"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/media_video_quicktime",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
