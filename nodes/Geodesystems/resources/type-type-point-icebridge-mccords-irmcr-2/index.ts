...
export const typeTypePointIcebridgeMccordsIrmcr2Description: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Icebridge Mccords Irmcr 2"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Icebridge Mccords Irmcr 2",
					"value": "Search Type Point Icebridge Mccords Irmcr 2",
					"action": "Search API for 'McCords Irmcr2 Data' entry type",
					"description": "API to search for entries of type McCords Irmcr2 Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_icebridge_mccords_irmcr2"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_icebridge_mccords_irmcr2",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Search Type Point Icebridge Mccords Irmcr 2"
					]
				}
			}
		},
