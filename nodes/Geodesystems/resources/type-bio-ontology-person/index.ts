...
export const typeBioOntologyPersonDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Bio Ontology Person"
					]
				}
			},
			"options": [
				{
					"name": "Search Bio Ontology Person",
					"value": "Search Bio Ontology Person",
					"action": "Search API for 'Person' entry type",
					"description": "API to search for entries of type Person",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_ontology_person"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_ontology_person",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Bio Ontology Person Gender",
			"name": "search-bio_ontology_person-gender",
			"description": "Gender",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.bio_ontology_person.gender",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
