...
export const typeTypeEsriRestfolderDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Restfolder"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Restfolder",
					"value": "Search Type Esri Restfolder",
					"action": "Search API for 'ESRI Services Folder' entry type",
					"description": "API to search for entries of type ESRI Services Folder",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_restfolder"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_restfolder",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
