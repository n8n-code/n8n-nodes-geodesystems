...
export const typeTypeMbDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Type Mb",
					"value": "Search Type Mb",
					"action": "Search API for 'MB Bathymetry' entry type",
					"description": "API to search for entries of type MB Bathymetry",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_mb"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_mb",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
