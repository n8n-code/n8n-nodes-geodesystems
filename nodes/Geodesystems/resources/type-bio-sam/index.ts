...
export const typeBioSamDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Bio Sam",
					"value": "Search Bio Sam",
					"action": "Search API for 'SAM Data' entry type",
					"description": "API to search for entries of type SAM Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/bio_sam"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/bio_sam",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
