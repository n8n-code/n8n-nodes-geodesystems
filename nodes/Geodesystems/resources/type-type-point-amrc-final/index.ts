...
export const typeTypePointAmrcFinalDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Point Amrc Final"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Point Amrc Final",
					"value": "Search Type Point Amrc Final",
					"action": "Search API for 'AMRC Final QC Data' entry type",
					"description": "API to search for entries of type AMRC Final QC Data",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_point_amrc_final"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_point_amrc_final",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Type Point Amrc Final Site ID",
			"name": "search-type_point_amrc_final-site_id",
			"description": "Site ID",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_amrc_final.site_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Point Amrc Final Site Name",
			"name": "search-type_point_amrc_final-site_name",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_amrc_final.site_name",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Type Point Amrc Final Argos ID",
			"name": "search-type_point_amrc_final-argos_id",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.type_point_amrc_final.argos_id",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
