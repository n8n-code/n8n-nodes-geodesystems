...
export const typeProjectStandardNameDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Project Standard Name"
					]
				}
			},
			"options": [
				{
					"name": "Search Project Standard Name",
					"value": "Search Project Standard Name",
					"action": "Search API for 'Standard Parameter Name' entry type",
					"description": "API to search for entries of type Standard Parameter Name",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/project_standard_name"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/project_standard_name",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "Search Project Standard Name Unit",
			"name": "search-project_standard_name-unit",
			...
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_standard_name.unit",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
		...
		{
			"displayName": "Search Project Standard Name Aliases",
			"name": "search-project_standard_name-aliases",
			"description": "Aliases",
			"default": "",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
					"property": "search.project_standard_name.aliases",
					"value": "={{ $value }}",
					"propertyInDotNotation": false
				}
			},
