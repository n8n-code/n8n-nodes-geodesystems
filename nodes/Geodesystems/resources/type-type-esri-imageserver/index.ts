...
export const typeTypeEsriImageserverDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Esri Imageserver"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Esri Imageserver",
					"value": "Search Type Esri Imageserver",
					"action": "Search API for 'ESRI Image Server' entry type",
					"description": "API to search for entries of type ESRI Image Server",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_esri_imageserver"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_esri_imageserver",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
