...
export const typeGlossaryDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					...
					"value": "Search Glossary",
					"action": "Search API for 'Glossary' entry type",
					"description": "API to search for entries of type Glossary",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/glossary"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/glossary",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
