...
export const typeBeforeafterDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Search Beforeafter",
					"value": "Search Beforeafter",
					"action": "Search API for 'Before and After Images' entry type",
					"description": "API to search for entries of type Before and After Images",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/beforeafter"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/beforeafter",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
