...
export const typeTypeUsgsGaugeDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Usgs Gauge"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Usgs Gauge",
					"value": "Search Type Usgs Gauge",
					"action": "Search API for 'USGS Stream Gauge' entry type",
					"description": "API to search for entries of type USGS Stream Gauge",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_usgs_gauge"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_usgs_gauge",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
