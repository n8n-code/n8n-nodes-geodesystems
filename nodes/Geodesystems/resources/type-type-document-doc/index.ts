...
export const typeTypeDocumentDocDescription: INodeProperties[] = [
                {
			...
			"displayOptions": {
				"show": {
					"resource": [
						"Type Type Document Doc"
					]
				}
			},
			"options": [
				{
					"name": "Search Type Document Doc",
					"value": "Search Type Document Doc",
					"action": "Search API for 'Word File' entry type",
					"description": "API to search for entries of type Word File",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/repository/search/type/type_document_doc"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /repository/search/type/type_document_doc",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
